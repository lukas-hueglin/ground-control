...
public:
  ...
  */
  ...
  /*!
    Defines if axis is centered, aligned or free
  */

  enum AxisFreedom { centered = 0x01 ///< <tt>0x01</tt> Axis is centerd on screen
                     ,aligned = 0x02 ///< <tt>0x01</tt> Axis aligned as in mAxisType specified
                     ,free = 0x03 ///< <tt>0x01</tt> Axis is totaly free
                   };
  Q_ENUMS(AxisFreedom)
  /*!
  ...
  */
  ...
  Q_SLOT void setAxisFreedom(const AxisFreedom &freedom);
...
protected:
  ...
  // specify if axis is centered, aligned or free
  AxisFreedom mAxisFreedom;
  // origin of axis
  double mOrigin;
